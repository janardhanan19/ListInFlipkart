...
public class PriceStockData {
    ...
    public void fillPriceStockDataFK(String product, String colour, String size) {
        fillPriceStockDataFK(product, colour, size, false);
    }
    public void fillPriceStockDataFK(String product, String colour, String size, boolean firstTime) {

        new GenericWrappers(driver)
                .sleep(3000)
                .waitUntil("//span[text()='Price, Stock and Shipping Information']//parent::div/div/button")
                .clickWithXpath("//span[text()='Price, Stock and Shipping Information']//parent::div/div/button")
                .sendKeysWithXpath("//input[@id='sku_id']", "FK-" + product + "-" + colour + "-" + size);
        if (firstTime) {
            new GenericWrappers(driver)
                    .selectByXpath("//select[@id='listing_status']", "ACTIVE");
        }
        new GenericWrappers(driver)
                .sendKeysWithXpath("//input[@id='mrp']", "799")
                .sendKeysWithXpath("//input[@id='flipkart_selling_price']", "399");
        if (firstTime) {
        ...
        if (firstTime) {
            new GenericWrappers(driver)
                    .selectByXpath("//select[@id='shipping_provider']", "FLIPKART")
                    .sendKeysWithXpath("//input[@id='local_shipping_fee_from_buyer']", "30")
                    .sendKeysWithXpath("//input[@id='zonal_shipping_fee_from_buyer']", "45")
                    .sendKeysWithXpath("//input[@id='national_shipping_fee_from_buyer']", "65")
                    .scrollToViewElement("//div[text()='Packaging details']")
